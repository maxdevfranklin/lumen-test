  ...
  "workExperiences": [
    {
      ...
      "position": "SPECIFIC role title that matches the job description domain and requirements - analyze the target job title and create a relevant, similar title that shows career progression toward that role",
      "achievements": [
        {
